...
(facts [[{:doc "raw"}]]
  ...
  "Within the raw js form, `self` only refers to the current nested object, unlike [obj](#obj) where it refers to the top level object."
